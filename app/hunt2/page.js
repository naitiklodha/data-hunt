				...
				<div className="bg-[#131313] bg-[url('../public/shapess.png')] bg-cover p-8 text-gray-300 rounded-2xl shadow-md w-[1278px] h-[685px] flex flex-row justify-around items-center object-cover ">
					<div className="w-full m-4">
						...
						<div className="text-xl m-4">
							As part of the quest, participants will encounter AR
							markers strategically placed at specific locations
							within the Coding Kingdom(Mini Auditorium).
							<br />
							<br /> These markers will bear the message "Scan
							Me," prompting participants to utilize an AR app to
							unveil the next hint or clue.
							<br />
							<br />
							Upon scanning the markers, participants will reveal
							hidden clues or receive instructions guiding them
