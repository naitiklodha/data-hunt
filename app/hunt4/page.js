						...
						<div className="text-xl m-4">
							...
							>
								<label className="text-xl">
									{" "}
									Behold the enchanted image below. Within its
									intricate patterns lies a hidden message,
									waiting to be discovered by those with keen
									observation skills. Your task is to examine
									the image closely and extract the secret
									message embedded within its depths. Once
									deciphered, input the hidden message into
									the text box provided, unlocking the pathway
									to further enlightenment in your Code Quest.
								</label>
								<input
									type="text"
